...
namespace iiifly.Util
{
    ...
    public class SimpleAES
    {
        ...
        static SimpleAES()
        {
            Key = GetBytesFromConfig("aes-key");
            Vector = GetBytesFromConfig("aes-vector");
        }

        static byte[] GetBytesFromConfig(string appSettingKey)
        {
            return ConfigurationManager.AppSettings[appSettingKey].Split(',').Select(byte.Parse).ToArray();
        }
